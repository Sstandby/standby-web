import { component$, useStore, useSignal, QwikMouseEvent, $, Slot } from "@builder.io/qwik";
...
export default component$(
  ({ hsize = "64", wsize = "80" }: BorderCardsProps) => {
    const size = `h-${hsize} w-${wsize}`;
    ...
    return (
      <div
        ...
        class={`relative flex ${size} rounded-2xl cursor-default border border-zin-400   p-3.5 text-slate-100 transition-colors duration-500`}
      >
        <div
          style={{
